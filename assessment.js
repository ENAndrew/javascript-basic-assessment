...
var removeItem = function(arr, removeString){
    var newArr = [];
    
    for(i=0; i < arr.length; i++){
        if(arr[i] !== removeString) {
            newArr.push(arr[i]);
        }
    }
    return newArr;
...
// Jeremy and then changes the person object to have a property called lovesCode with a value of 10.  If their name is Brack set lovesCode to 0.  
